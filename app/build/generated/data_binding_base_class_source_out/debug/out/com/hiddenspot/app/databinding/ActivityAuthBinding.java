...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnAction,
      @NonNull MaterialButton btnApple, @NonNull MaterialButton btnGoogle,
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAuthBinding((ScrollView) rootView, btnAction, btnApple, btnGoogle, etEmail,
          etPassword, etUsername, ivLogo, layoutHeader, tilEmail, tilPassword, tilUsername,
          tvForgot, tvSubtitle, tvTitle, tvToggleAction, tvToggleLabel);
    }
